...
(function () {
  ...
  function renderTabs() {
    var _templateTab = "\n\t\t".concat(characters.map(function (character, index) {
      return "<li class=\"".concat(index === 0 ? 'is-active' : '', "\">\n\t\t\t\t\t<a>").concat(character.toUpperCase(), "</a>\n\t\t\t\t</li>");
    }).join(""));
  ...
  function renderRoutes() {
    ...
    var _templateCard = "".concat(_currentRoutes.map(function (route) {
      return "\n\t\t\t\t<div class=\"box\">\n\t\t\t\t\t<div class=\"box-header level mb-5\">\n\t\t\t\t\t\t<h5 class=\"title is-5 level-left mb-0\"># ".concat(route.title, " - ").concat(route.position, "</h4>\n\t\t\t\t\t\t<p class=\"level-right mb-0\">\n\t\t\t\t\t\t\tDamage: <span class=\"has-text-info ml-1\">").concat(route.damage, "</span>\n\t\t\t\t\t\t</p>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"box-content\">\n\t\t\t\t\t\t<div class=\"mb-4\">\n\t\t\t\t\t\t\t<pre style=\"overflow-x: auto; white-space: pre-wrap; word-wrap: break-word;\">").concat(route.inputs, "</pre>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class=\"youtube\">\n\t\t\t\t\t\t\t").concat(route.video ? "<iframe width=\"100%\" height=\"500\" src=\"https://www.youtube.com/embed/".concat(route.video, "\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture\" allowfullscreen></iframe>") : "", "\n\t\t\t\t\t\t\t\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"box-footer\"></div>\n\t\t\t\t</div>\n\t\t\t\t");
    }).join(""));
